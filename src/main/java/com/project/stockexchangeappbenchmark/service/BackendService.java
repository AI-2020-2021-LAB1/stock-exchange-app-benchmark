...
public class BackendService {
    ...
    public void login() {
        ...
        form.put("username", "adudek@adudek.pl");
        form.put("password", "Adudek@dud3k");
        form.put("scope", "any");
        form.put("grant_type", "password");
        byte[] encodedAuth = createBasicAuthentication();
        HttpRequest req = HttpRequest.newBuilder()
                .uri(URI.create("http://193.33.111.196:8000/oauth/token"))
    ...
    public void register() {
        ...
        body.setEmail("adudek@adudek.pl");
        body.setPassword("Adudek@dud3k");
        body.setFirstName("Artur");
        body.setLastName("Dudek");
        byte[] encodedAuth = createBasicAuthentication();
        try {
            HttpRequest req = HttpRequest.newBuilder()
                    .uri(URI.create("http://193.33.111.196:8000/api/register"))
                    .setHeader("Authorization", "Basic " + new String(encodedAuth))
